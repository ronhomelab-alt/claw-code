...
private fun FilterApp(
    ...
    Scaffold(
        topBar = { TopAppBar(title = { Text("SMS Spam Filter") }) },
    ) { padding ->
    ...
    Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
        ...
        Card(Modifier.fillMaxWidth()) {
            Column(Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                Text(
                    "Blocked texts are quarantined before any inbox or notification. " +
                        "This replaces Google Messages as your default SMS app — Android " +
                        "allows only one default at a time."
                )
